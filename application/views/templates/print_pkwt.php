...
<body>
    ...
    <center><br><br>
        <h2> PERJANJIAN KERJA WAKTU TERTENTU (PKWT)
        ...
        <b style="font-size: 15pt;">PT. AKT INDONESIA</b><br>
        SEBAGAI <br>
        <b style="font-size: 10pt;">PENGUSAHA</b><br><br><br><br>
        DENGAN <br><br><br><br>
        <b style="font-size: 15pt;"><?= $karyawan['nama'] ?></b><br>
        <b style="font-size: 15pt;">NIK : <?= $karyawan['nik_akt'] ?> </b>
    ...
    <div class="content">
        <center>
            <h3>PERJANJIAN KERJA WAKTU TERTENTU (PKWT)</h3>
        </center>
        <hr>
    ...
    <li>Tunjangan Hari Raya / THR bagi Pekerja 1 Tahun atau lebih dibayarkan sebesar 1 kali Gaji.</li> -->
            <li>Tunjangan hari raya / THR hanya diberikan kepada pekerja dengan masa kerja lebih dari 30 hari setelah penandatanganan Perjanjian Kerja Waktu Tertentu yang sedang dijalaninya dan masa berlakunya Perjanjian kerja waktu tertentu tersebut tidak berakhir sebelum pelaksanaan hari raya.
            </li>
            <li>
                Tunjangan hari raya / THR bagi Pekerja dengan masa lebih dari 30 hari dan di bawah 1 Tahun, akan dihitung secara proporsional sesuai masa kerja dari perjanjian kerja yang sedang dijalaninya.
            </li>
            <li>
                Tunjangan hari raya / THR bagi Pekerja yang telah bekerja selama 1 Tahun atau lebih dibayarkan sebesar 1 kali Gaji.
            </li>
        ...
        <ol type="1">
            ...
            <li>Kewajiban Pekerja.
                <ol type="A">
                    <li>Melaksanakan pekerjaan sebagaimana yang diperjanjikan dengan sebaik-baiknya serta sejujur-jujurnya sesuai Standart Operasional Prosedur (SOP) / Job Description / Peraturan Perusahaan (PP) yang telah <br><br><br><br><br><br><br> ditetapkan;</li>
    ...
    <div class="content">
        ...
        <ul>
            <li>
                <p>9.1.6. Pihak Perusahaan dapat mengakhiri perjanjian ini sewaktu-waktu apabila pihak Pekerja telah melakukan pelanggaran peraturan perusahaan (PP), standart operasional prosedur (SOP) ataupun peraturan perundang-undangan yang berlaku yang dapat dikenakan sanksi pemutusan hubungan kerja;
    ...
    <div class="content">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Apabila pihak pekerja berniat untuk <u> tidak melanjutkan</u>/menerima kontrak baru dan atau perubahan jenis perjanjian kerja baru yang mungkin akan diberikan oleh perusahaan setelah berakhirnya perjanjian kerja ini, maka pihak pekerja wajib memberitahukan kepada pihak manajemen perusahaan minimal <u>30 (Tiga Puluh) hari kerja</u> sebelum berakhirnya perjanjian kerja ini,
        Keterlambatan pemberitahuan seperti tersebut di atas, akan mengakibatkan pihak pekerja dikategorikan sebagai pengunduran diri secara sepihak atau pengunduran diri yang tidak mengikuti regulasi yang seharusnya, dan akan dikenai sanksi administratif sesuai jenis perjanjian kerja yang berlaku saat ini. <br>
        ...
        <p>
        <h4>JENIS PELANGGARAN YANG DAPAT DIKENAKAN PEMUTUSAN HUBUNGAN KERJA<br>
            Pasal 10</h4>
        ...
        <ol type="1">
            ...
            <li>
                Pihak Pekerja dengan ini menerima dan atau sepakat dengan Pihak Perusahaan, bahwasanya Pihak Perusahaan selalu berusaha memenuhi ketentuan perundang-undangan ketenagakerjaan mengenai pembayaran upah jam kerja lembur.
                Namun jika dalam pemenuhan kewajiban perintah/tugas untuk bekerja lembur yang diterima dan dijalankan, Pihak Pekerja tidak bisa memenuhi permintaan Pihak Perusahaan baik dalam satuan hasil kerja, satuan waktu kerja dan atau skala efisiensi dan produktivitas berdasarkan penilaian dari Pihak Perusahaan yang mana dengan ini juga disepakati oleh Pihak Pekerja sebagai dasar penilaian yang valid dan bisa diterima, <br>
                Maka untuk kondisi tersebut diatas, Pihak Pekerja bersedia dan menerima bahwa pembayaran upah atas perintah untuk bekerja lembur tersebut hanya dibayarkan sesuai dengan tarif jam kerja biasa dan bukan sebagai tarif jam kerja lembur.
            ...
            <li>Hak Cuti Tahunan Pihak Pekerja selama 12 hari kerja pada tahun itu baru akan timbul <b><u>SETELAH</u></b> Pihak Kedua bekerja selama 12 bulan secara terus menerus namun apabila ternyata Pihak Pengusaha tidak memperpanjang perjanjian ini sebagaimana tanggal yang tertera di dalam perjanjian ini maka hak cuti tahunan Pihak Pekerja pada
                <br><br><br><br><br><br><br><br> tahun itu dengan sendirinya belum ada / belum timbul sebagaimana ditentukan di dalam pasal 79 ayat 2 huruf c UU No.13 Tahun 2003 Tentang Ketenagakerjaan sehingga tidak ada kewajiban hukum Pihak Perusahaan untuk memberikan hak cuti tahunan tersebut.
            </li>
        </ol>
        ...
        Para pihak setelah membaca isi perjanjian ini dengan teliti dan seksama maka masing-masing pihak telah membubuhkan tanda-tangan sebagaimana tersebut dibawah ini
        </p>
        <br>
    </div>
    <div>
        <center>
            <table border="0">
                ...
                <tr style="text-align: left;">
                    <td style="width: 250px;">Pasuruan, <?= format_indo(date("Y-m-d", strtotime($karyawan['start_kontrak']))); ?> <br>Para Pihak, <br>Pihak Pertama</td>
                ...
                <tr style="text-align: left;">
                    <td>
                        ...
                        if ($pkwt) :
                            foreach ($pkwt as $row) :
                        ?>
                                <b><u> <?= $row['nama_hrd'] ?></u></b>
                            <?php endforeach; ?>

                        <?php endif; ?>
                        <br> <b>Jabatan : HRD </b>
                        <br> <b>Nama Perusahaan : PT. AKT INDONESIA</b>
                    </td>
                    <td></td>
